...
public class RentalAgreementListViewModel : BaseViewModel
{
    ...
    public RentalAgreementListViewModel(
    ...
    {
        var rentalAgreementViewModel = _viewModelFactory.CreateRentalAgreementViewModel(new RentalAgreement());
        _currentViewService.OnViewChanged?.Invoke(rentalAgreementViewModel);
    }
